        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex gap-4">
            ...
            <div className="grid grid-cols-2">
              ...
              <p className="before:mr-1 before:content-[':'] break-words"><input
                  type="text"
                  name="nama"
                  value={nama}
              ...
              <p className="before:mr-1 before:content-[':'] break-words">
                <input
                  type="text"
                  name="nis"
                  value={nis}
...
const AdminStudents = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedSiswaId) {
        response = await axios.put(`${baseUrl}admin/siswa/${selectedSiswaId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/siswa`, formData);
      }
