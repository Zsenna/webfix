...
const AdminExtracurricular = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const ekskulResponse = await axios.get(`${baseUrl}ekstrakurikuler/favorite`);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const ekskulResponse = await axios.get(`${baseUrl}ekstrakurikuler/pilihan`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedEkskulId) {
        response = await axios.put(`${baseUrl}admin/ekstrakurikuler/favorite/${selectedEkskulId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/ekstrakurikuler/favorite`, formData);
      }
  ...
  const handleSubmit1 = async (e) => {
    ...
    try {
      ...
      if (selectedEkskulId1) {
        response = await axios.put(`${baseUrl}admin/ekstrakurikuler/pilihan/${selectedEkskulId1}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/ekstrakurikuler/pilihan`, formData);
      }
