...
const AdminGallery = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const ekskulResponse = await axios.get(`${baseUrl}galeri`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedGalerisId) {
        response = await axios.put(`${baseUrl}admin/galeri/${selectedGalerisId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/galeri`, formData);
      }
