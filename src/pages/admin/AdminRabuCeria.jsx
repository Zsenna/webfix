...
const AdminRabuCeria = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const racerResponse = await axios.get(`${baseUrl}rabuceria`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedRabuceriaId) {
        response = await axios.put(`${baseUrl}admin/rabuceria/${selectedRabuceriaId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/rabuceria`, formData);
      }
