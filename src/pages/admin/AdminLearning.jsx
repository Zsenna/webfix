...
const AdminLearning = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const prokerResponse = await axios.get(`${baseUrl}organisasi`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedProkerId) {
        response = await axios.put(`${baseUrl}admin/organisasi/${selectedProkerId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/organisasi`, formData);
      }
