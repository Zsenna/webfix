...
const AdminSchoolGround = () => {
 ...
 useEffect(() => {
    const fetchData = async () => {
      ...
      const response1 = await axios.get(`${baseUrl}denahruang`);
      setDenahRuangan(response1.data);

      const response2 = await axios.get(`${baseUrl}denahdetail`);
      setDenahDetail(response2.data);
        
      const response3 = await axios.get(`${baseUrl}denahdetail1`);
      setDenahDetail1(response3.data);
        
      const response4 = await axios.get(`${baseUrl}denahdetail2`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedDenahRuangId) {
        response = await axios.put(`${baseUrl}admin/denahruang/${selectedDenahRuangId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/denahruang`, formData);
      }
  ...
  const handleSubmit1 = async (e) => {
    ...
    try {
      ...
      if (selectedDenahDetailId) {
        response = await axios.put(`${baseUrl}admin/denahdetail/${selectedDenahDetailId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/denahdetail`, formData);
      }
  ...
  const handleSubmit2 = async (e) => {
    ...
    try {
      ...
      if (selectedDenahDetailId) {
        response = await axios.put(`${baseUrl}admin/denahdetail1/${selectedDenahDetailId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/denahdetail1`, formData);
      }
  ...
  const handleSubmit3 = async (e) => {
    ...
    try {
      ...
      if (selectedDenahDetailId) {
        response = await axios.put(`${baseUrl}admin/denahdetail2/${selectedDenahDetailId}`, formData);
      } else {
        response = await axios.post(`${baseUrl}admin/denahdetail2`, formData);
      }
            ...
            >
              {
                denahRuangan.map((ruanggItem) => (
                  <div
                    ...
                    <img
                      className="scale-75"
                      src={`${baseUrl}${ruanggItem.fotoDenah}`}
                      alt="Denah Sekolah"
                    />
                  </div>
                ))
