      ...
      <div>
        {
          profil.map(introItem => (
            <div style={{ width: '100%', overflowX: 'auto' }}
              ...
              <div
                className="our-app-wrapper block !font-poppins"
    ...
    <div>
      {
        ...
        <div key={strukturItem}>
          <img src={`${baseUrl}${strukturItem.struktur}`} alt="Struktur Organisasi" />
        </div>
        )
        )
      }
      ...
      <div className="relative">
        ...
        <div className="mb-4 flex w-full items-center justify-evenly rounded-b-lg bg-dark-seagreen py-8">
          <img
            ...
            src={`${baseUrl}${denahRuangan[0]?.fotoDenah}`}
            alt="Denah Sekolah"
          />
          <img
            className={classNames(
            ...
            src={`${baseUrl}${denahRuangan[1]?.fotoDenah}`}
            alt="Denah Sekolah"
          />
          <img
            className={classNames(
            ...
            src={`${baseUrl}${denahRuangan[2]?.fotoDenah}`}
            alt="Denah Sekolah"
          />
        </div>
      </div>
...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const profilResponse = await axios.get(`${baseUrl}profil`);
