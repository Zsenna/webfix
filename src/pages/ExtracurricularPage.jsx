          ...
          <div className="flex gap-4">
            <div className="flex justify-center">
              <img
                ...
                src={`${baseUrl}${selectedekskul?.picture}`}
                alt=""
              />
            </div>
            <div className="flex justify-center">
              <img
                className="h-48 w-64 rounded-lg"
                src={`${baseUrl}${selectedekskul?.picture2}`}
                alt=""
              />
            </div>
            <div className="flex justify-center">
              <img
                className="h-48 w-64 rounded-lg"
                src={`${baseUrl}${selectedekskul?.picture3}`}
                alt=""
              />
            </div>
          </div>
        ...
        <div className="flex flex-col gap-4 font-poppins leading-5">
          ...
          <div className="flex gap-4">
            <div className="flex justify-center">
              <img
                className="h-48 w-64 rounded-lg"
                src={`${baseUrl}${selectedekskul1?.picture}`}
                alt=""
              />
            </div>
            <div className="flex justify-center">
              <img
                className="h-48 w-64 rounded-lg"
                src={`${baseUrl}${selectedekskul1?.picture2}`}
                alt=""
              />
            </div>
            <div className="flex justify-center">
              <img
                className="h-48 w-64 rounded-lg"
                src={`${baseUrl}${selectedekskul1?.picture3}`}
                alt=""
              />
            </div>
          </div>
    ...
    const fetchData = async () => {
      try {
        const [ekskulResponse, ekskulResponse1] = await Promise.all([
          axios.get(`${baseUrl}ekstrakurikuler/favorite`),
          axios.get(`${baseUrl}ekstrakurikuler/pilihan`)
        ]);
